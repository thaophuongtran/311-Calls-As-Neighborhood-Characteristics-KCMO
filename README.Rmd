...
The number of total requests during the time frame for the 311 data in KCMO is at 117 thousands, about a fifth of the city's population during the same year. Kansas City's 311 data are categorized in 15 types.
...
K3N25_label %>% 
  ...
  arrange(Cluster) %>% 
  kable(caption = "Table 3: K-Means classication of neighborhoods based on 311 call volumes")
